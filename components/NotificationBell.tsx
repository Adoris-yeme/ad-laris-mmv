...
const NotificationBell: React.FC<NotificationBellProps> = ({ notifications, onMarkAsRead }) => {
    ...
    return (
        <div ref={ref} className="relative">
            ...
            {isOpen && (
                <div className="absolute right-0 bottom-full mb-2 w-80 bg-white dark:bg-stone-800 rounded-lg shadow-2xl border border-stone-200 dark:border-stone-700 overflow-hidden animate-fade-in-up">
