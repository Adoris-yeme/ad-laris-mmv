...
const ModelDetail: React.FC<ModelDetailProps> = ({ model, onClose, isModelOfTheMonth, onSetModelOfTheMonth, isFavorite, onToggleFavorite, userMode, onStartOrder }) => {
  ...
  const mainImage = imageUrls?.[selectedImageIndex] || imageUrls?.[0] || 'https://images.unsplash.com/photo-1549298236-834b6f0e495d?q=80&w=400&h=500&fit=crop';
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex flex-col bg-stone-100 dark:bg-stone-950 relative group">
            <div className="flex-1 flex items-center justify-center overflow-hidden p-4">
              <img src={mainImage} alt={`${model.title} - vue ${selectedImageIndex + 1}`} className="max-w-full max-h-full w-auto h-auto object-contain" />
            </div>
             <button
